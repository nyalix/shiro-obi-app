...
class DoneItemViewController: UIViewController, UITextViewDelegate  {
    
    var donetask: Done? = nil
    ...
    func editTask() {
        donetask?.item = todoField.text
        donetask?.managedObjectContext!.MR_saveToPersistentStoreAndWait()
    }
